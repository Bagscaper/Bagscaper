...
IL_0035:
	{
		...
		V_1 = L_10;
		int32_t L_11 = V_1;
		Dictionary_2_Resize_m3649600DC6ADE47F2FA763E3263C6123CF89B0F6(__this, L_11, (bool)0, il2cpp_rgctx_method(method->klass->rgctx_data, 54));
		int32_t L_12 = V_1;
		return L_12;
	}
}
...
IL_0009:
	...
	try
	{
		...
		try
		{
			...
			RuntimeObject* L_4 = ___1_value;
			Dictionary_2_set_Item_m125C5A0AEAB4CD16A68FBBD7BD94B186DA0BEF6A(__this, L_3, ((*(NativeArray_1_t8B168617F2E2FBA4473810E911C21C95E6A2E9F6*)UnBox(L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 15)))), il2cpp_rgctx_method(method->klass->rgctx_data, 59));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
...
IL_0035:
	{
		...
		V_1 = L_10;
		int32_t L_11 = V_1;
		Dictionary_2_Resize_m2E8CB902121C62F6118E925BA8B374B74523B2CA(__this, L_11, (bool)0, il2cpp_rgctx_method(method->klass->rgctx_data, 54));
		int32_t L_12 = V_1;
		return L_12;
	}
}
